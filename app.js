...
const TEXT = {
  en: {
    ...
    recount: {
      ...
      toolText: 'The generator that produces this site\'s figures will be published as open source, to run against your own db-sync. A competing window on the same label is welcome: it is what keeps this one honest.',
  ...
  es: {
    ...
    openUntil: (e, when) => `Abierta como máximo hasta el final de la época ${e}${when ? ' · cierra a más tardar el ' + when : ''}`,
    ...
    groups: { 'Delegated to a DRep': 'Delegada en un DRep', 'Always abstain': 'Siempre abstenerse', 'Always no confidence': 'Siempre sin confianza', 'No DRep chosen': 'Sin DRep elegido' },
    ...
    byDelegation: 'Por delegación', byDelegationNote: 'Agrupadas según el DRep que tenía cada billetera cuando se presentó la acción.',
    thWho: 'Delegación',
    ...
    recount: {
      ...
      toolText: 'El generador que produce las cifras de este sitio se publicará como código abierto, para ejecutarlo contra tu propio db-sync. Una ventana competidora sobre la misma etiqueta es bienvenida: es lo que mantiene honesta a esta.',
