...
with sync_playwright() as p:
    ...
    must(pg.url.endswith('contact.html') and not pg.locator('.nav').is_visible(), 'phone: item navigates, menu folded on the new page')
    ...
    pg2.goto(BASE + "/index.html"); pg2.wait_for_timeout(1200)
